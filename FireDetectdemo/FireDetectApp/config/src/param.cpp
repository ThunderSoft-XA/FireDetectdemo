...
int camera_param_load(char *fileName, ST_CameraConf* pstCameraConf)
{
	...
	pstCameraConf->w_x = param_get_int(pstCameraConf->camera_dic,"w_x",0);
	pstCameraConf->w_y = param_get_int(pstCameraConf->camera_dic,"w_y",0);
	pstCameraConf->w_w = param_get_int(pstCameraConf->camera_dic,"w_w",320);
	pstCameraConf->w_y = param_get_int(pstCameraConf->camera_dic,"w_h",240);

	param_deinit();
	printf("%s\n",__FUNCTION__);
	printf("cameraID: %d\n",pstCameraConf->cameraID);
